...
namespace BrevoDotNet.Model
{
    ...
    /// UpdateSmsCampaign
    /// </summary>
    public partial class UpdateSmsCampaign : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public UpdateSmsCampaign(Option<string?> name = default, Option<string?> sender = default, Option<string?> content = default, Option<CreateSmsCampaignRecipients?> recipients = default, Option<DateTime?> scheduledAt = default)
        {
            NameOption = name;
            SenderOption = sender;
    ...
    /// <summary>
    /// A Json converter for type <see cref="UpdateSmsCampaign" />
    /// </summary>
    public class UpdateSmsCampaignJsonConverter : JsonConverter<UpdateSmsCampaign>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="UpdateSmsCampaign" />
        /// </summary>
        ...
        public override UpdateSmsCampaign Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class UpdateSmsCampaign.");

            if (sender.IsSet && sender.Value == null)
                throw new ArgumentNullException(nameof(sender), "Property is not nullable for class UpdateSmsCampaign.");

            if (content.IsSet && content.Value == null)
                throw new ArgumentNullException(nameof(content), "Property is not nullable for class UpdateSmsCampaign.");

            if (recipients.IsSet && recipients.Value == null)
                throw new ArgumentNullException(nameof(recipients), "Property is not nullable for class UpdateSmsCampaign.");

            if (scheduledAt.IsSet && scheduledAt.Value == null)
                throw new ArgumentNullException(nameof(scheduledAt), "Property is not nullable for class UpdateSmsCampaign.");

            return new UpdateSmsCampaign(name, sender, content, recipients, scheduledAt);
        }

        /// <summary>
        /// Serializes a <see cref="UpdateSmsCampaign" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="updateSmsCampaign"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, UpdateSmsCampaign updateSmsCampaign, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, updateSmsCampaign, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="UpdateSmsCampaign" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="updateSmsCampaign"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, UpdateSmsCampaign updateSmsCampaign, JsonSerializerOptions jsonSerializerOptions)
        {
            if (updateSmsCampaign.NameOption.IsSet && updateSmsCampaign.Name == null)
                throw new ArgumentNullException(nameof(updateSmsCampaign.Name), "Property is required for class UpdateSmsCampaign.");

            if (updateSmsCampaign.SenderOption.IsSet && updateSmsCampaign.Sender == null)
                throw new ArgumentNullException(nameof(updateSmsCampaign.Sender), "Property is required for class UpdateSmsCampaign.");

            if (updateSmsCampaign.ContentOption.IsSet && updateSmsCampaign.Content == null)
                throw new ArgumentNullException(nameof(updateSmsCampaign.Content), "Property is required for class UpdateSmsCampaign.");

            if (updateSmsCampaign.RecipientsOption.IsSet && updateSmsCampaign.Recipients == null)
                throw new ArgumentNullException(nameof(updateSmsCampaign.Recipients), "Property is required for class UpdateSmsCampaign.");

            if (updateSmsCampaign.NameOption.IsSet)
                writer.WriteString("name", updateSmsCampaign.Name);

            if (updateSmsCampaign.SenderOption.IsSet)
                writer.WriteString("sender", updateSmsCampaign.Sender);

            if (updateSmsCampaign.ContentOption.IsSet)
                writer.WriteString("content", updateSmsCampaign.Content);

            if (updateSmsCampaign.RecipientsOption.IsSet)
            {
                writer.WritePropertyName("recipients");
                JsonSerializer.Serialize(writer, updateSmsCampaign.Recipients, jsonSerializerOptions);
            }
            if (updateSmsCampaign.ScheduledAtOption.IsSet)
                writer.WriteString("scheduledAt", updateSmsCampaign.ScheduledAtOption.Value!.Value.ToString(ScheduledAtFormat));
        }
    }
}
