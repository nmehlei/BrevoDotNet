...
namespace BrevoDotNet.Test.Model
{
    ...
    public class UpdateEmailCampaignTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" UpdateEmailCampaign
            //Assert.IsType<UpdateEmailCampaign>(instance);
        }
