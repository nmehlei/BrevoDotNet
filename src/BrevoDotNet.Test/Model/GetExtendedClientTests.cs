...
namespace BrevoDotNet.Test.Model
{
    ...
    public class GetExtendedClientTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" GetExtendedClient
            //Assert.IsType<GetExtendedClient>(instance);
        }
