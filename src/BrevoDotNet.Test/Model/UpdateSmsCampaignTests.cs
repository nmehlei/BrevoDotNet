...
namespace BrevoDotNet.Test.Model
{
    ...
    public class UpdateSmsCampaignTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" UpdateSmsCampaign
            //Assert.IsType<UpdateSmsCampaign>(instance);
        }
