...
namespace BrevoDotNet.Test.Model
{
    ...
    public class GetSmsCampaignTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" GetSmsCampaign
            //Assert.IsType<GetSmsCampaign>(instance);
        }
