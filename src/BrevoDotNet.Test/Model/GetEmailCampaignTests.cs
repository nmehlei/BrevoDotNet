...
namespace BrevoDotNet.Test.Model
{
    ...
    public class GetEmailCampaignTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" GetEmailCampaign
            //Assert.IsType<GetEmailCampaign>(instance);
        }
